(function () {
    ...
    var displayPopUp = function (target) {
        $("header").fadeOut(TS / 2, function () {
            $(target).fadeIn(TS);
        });
    }
    ...
    switchPopUp = function (targerFrom, targerTo) {
        $(targerFrom).fadeOut(TS, function () {
            $(targerTo).fadeIn(TS);
        });
    }
    ...
    $(document).ready(function () {
        ...
        $('.dropdown_checkbox-head input[type="checkbox"]').click(function (e) {
        ...
        $("#add_measurement_button").click(function () {
            ...
            $("#measure_adder_close_button").attr("onclick", 'measurePopUpClose()');
        });
        ...
        $("#manage_measurement_button").click(function () {
            var targer = $("#customize_measure");
            displayPopUp(targer);
            $("#mange_measure_window").fadeIn(TS);
        });
        //-SWITCH
        simpleSwitchToMsr = function () {
            var targerFrom = $("#mange_measure_window");
            var targerTo = $("#add_measure_window");
            switchPopUp(targerFrom, targerTo);
        ...
        managerSwitchMeasure = function () {
            simpleSwitchToMsr();
            var measureInput = $("#add_measure_form input[type='text']");
            $(measureInput).val("");
        ...
        measurePopUpBack = function () {
            var targerFrom = $("#add_measure_window");
            var targerTo = $("#mange_measure_window");
            switchPopUp(targerFrom, targerTo);
