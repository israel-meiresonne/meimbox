...
<head>
    ...
    ?>
    <script src="outside/js/checkout.js"></script>
    <link rel="stylesheet" href="outside/css/checkout.css">
</head>
                                        ...
                                        <div class="cart-discount-input-block">
                                            <div class="input_button_left-wrap">
                                                ...
                                                <div class="input_button_left-button-block">
                                                    <button class="green-button remove-button-default-att">apply</button>
                                                </div>
                                            </div>
                                        </div>
