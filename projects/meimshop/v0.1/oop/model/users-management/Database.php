...
class Database
{
    ...
    public function getProductMapSearch($queryWhereOrderBy)
    {
        ...
        $array = $this->getProdDatas($productTable, $productMap_search, $prodIdList);
        ...
        $productMap_search = $this->getProdDescription($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdPrices($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdShippings($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdDiscounts($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdPictures($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdSizes($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getBoxProdSizes($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdCollections($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdFunctions($productMap_search, $queryWHERE_prodId);
        $productMap_search = $this->getProdCategories($productMap_search, $queryWHERE_prodId);
